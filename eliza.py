...
def respond(sentence):
    ...
    for rule, value in compiled:
        ...
        if match is not None:
            ...
            if resp.endswith('??'): resp = resp[:-2] + '?'
            return cap_first(resp.replace("me am ", 'I am '))
#----------------------------------------------------------------------
#   Main program
#----------------------------------------------------------------------
#----------------------------------------------------------------------
# reflection_of, used to things the computer says back,
# e.g. "I am" --> "you are"
#----------------------------------------------------------------------
reflection_of = {
    "am"    : "are",
...
#   %1, %2, etc.
#----------------------------------------------------------------------
compiled = [(re.compile(x[0], re.I), x[1]) for x in [
   ['How are you?',
      [ "I'm fine, thank you."]],
    ["I need (.*)",
    [   "Why do you need %1?",
